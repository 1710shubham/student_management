...
class PasswordResetRequest(models.Model):
    ...
    token = models.CharField(max_length=100,default=get_random_string(32),editable=False,unique=True) # type: ignore
    ...
    def send_reset_email(self):
        ...
        send_mail( # type: ignore
            ...
            f'Click the link below to reset youe password\n{reset_link}',
